...
* `memory_zswap_bytes_used`: Zswap memory usage, in Bytes. Collected from `/proc/meminfo` (`Zswap`).
* `memory_zswap_compression_efficiency`: Zswap compression efficiency ratio (`Zswapped` / `Zswap`).
