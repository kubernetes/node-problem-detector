...
var NPDMetricToSDMetric = map[metrics.MetricID]string{
	...
	metrics.CgroupCPUPeriodsCount:          "kubernetes.io/internal/node/guest/cgroup/cpu/periods_count",
	metrics.CgroupCPUThrottledPeriodsCount: "kubernetes.io/internal/node/guest/cgroup/cpu/throttled_periods_count",
	metrics.CgroupCPUThrottledTime:         "kubernetes.io/internal/node/guest/cgroup/cpu/throttled_time",
	metrics.CgroupCPUUsagePerCPU:           "kubernetes.io/internal/node/guest/cgroup/cpu/usage_percpu",
	metrics.CgroupCPUTime:                  "kubernetes.io/internal/node/guest/cgroup/cpu/time",
	metrics.CgroupMemoryUsage:              "kubernetes.io/internal/node/guest/cgroup/memory/usage",
	metrics.CgroupMemoryLimit:              "kubernetes.io/internal/node/guest/cgroup/memory/limit",
	metrics.CgroupMemoryFailcntCount:       "kubernetes.io/internal/node/guest/cgroup/memory/failcnt_count",
	metrics.CgroupPidsCurrentCount:         "kubernetes.io/internal/node/guest/cgroup/pids/current_count",
}
