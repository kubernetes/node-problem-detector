...
const (
	...
	CgroupCPUPeriodsCount          MetricID = "cgroup/cpu/periods_count"
	CgroupCPUThrottledPeriodsCount MetricID = "cgroup/cpu/throttled_periods_count"
	CgroupCPUThrottledTime         MetricID = "cgroup/cpu/throttled_time"
	CgroupCPUUsagePerCPU           MetricID = "cgroup/cpu/usage_percpu"
	CgroupCPUTime                  MetricID = "cgroup/cpu/time"
	CgroupMemoryUsage              MetricID = "cgroup/memory/usage"
	CgroupMemoryLimit              MetricID = "cgroup/memory/limit"
	CgroupMemoryFailcntCount       MetricID = "cgroup/memory/failcnt_count"
	CgroupPidsCurrentCount         MetricID = "cgroup/pids/current_count"
)
